...
export function DefaultMetas(): JSX.Element {
  return (
    <Helmet>
      ...
      <meta name="keywords" content="moaloa, 모아로아, 로스트아크, 보석시세, 영지제작, 생활재료 판매, 경매 계산기" />
      <meta name="description" content="로스트아크의 도구 모음사이트 모아로아 Moaloa입니다. 보석 검색, 영지 제작, 생활재료 판매, 경매 계산기 기능을 제공합니다." />
      ...
      <meta property="og:description" content="로스트아크의 도구 모음사이트 모아로아 Moaloa입니다. 보석 검색, 영지 제작, 생활재료 판매, 경매 계산기 기능을 제공합니다." />
    </Helmet>
  );
}
...
export function MaterialMetas(): JSX.Element {
  return (
    <Helmet>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <meta name="keywords" content="moaloa, 모아로아, 로스트아크, 보석시세, 영지제작, 생활재료 판매, 경매 계산기" />
      <meta name="description" content="생활재료를 판매할때 최대 효율을 알려주는 기능을 제공합니다." />
      <meta name="author" content="Moaloa" />
      <meta name="robots" content="index,follow" />
      <meta property="og:url" content="https://moaloa.org/material" />
      <meta property="og:type" content="website" />
      <meta property="og:title" content="생활재료판매 - 모아로아 MoaLoa" />
      <meta property="og:description" content="생활재료를 판매할때 최대 효율을 알려주는 기능을 제공합니다." />
    </Helmet>
  );
}
